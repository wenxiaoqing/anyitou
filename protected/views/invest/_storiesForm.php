...
<div class="form-horizontal" >
    ...
    <div class="panel panel-primary">
    	...
    	<div class="panel-body" >
			...
			<div class="form-group">
				<label for="is_recommend" class="col-sm-2 control-label"><?php echo $model->getAttributeLabel('recommend'); ?>：<span class="required">*</span></label>
				<div class="col-sm-5">
				<select class="form-control col-sm-4 isrequired" name="InvestStories[recommend]" >
					<?php foreach($model->isRecommend as $key => $value){?>
					<option value="<?php echo $key;?>" <?php if($model->recommend == $key) { echo 'selected'; } ?> ><?php echo $value;?></option>
					<?php }?>
				</select>
				</div>
  				<div class="col-sm-5 control-info"></div>
			...
			<div class="form-group">
				...
				<div class="col-sm-5">
				<select class="form-control col-sm-4 isrequired" name="InvestStories[status]" >
...
$(document).ready(function() {
	...
	KindEditor.ready(function(K) {
		$('#StoriesForm textarea').each(function(){
...
function checkFrom() {
	...
	var _hastips = false;
	var tipStr = '';
	$('#StoriesForm .isrequired').each(function(){
