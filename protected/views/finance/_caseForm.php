...
<div class="form-horizontal" >
    ...
    <div class="panel panel-primary">
    	...
    	<div class="panel-body" >
			...
			<div class="form-group">
				...
				<div class="col-sm-5">
				<select class="form-control col-sm-4 isrequired" name="FinanceCase[recommend]" >
			...
			<div class="form-group">
				...
				<div class="col-sm-5">
				<select class="form-control col-sm-4 isrequired" name="FinanceCase[status]" >
	...
	<div class="text-center">
        ...
        <button type="button" class="btn btn-large btn-primary" id="submitBtn" >提交融资案例</button>
    </div>
	<?php $this->endWidget(); ?>
</div>
<?php 
...
$(document).ready(function() {
	...
	KindEditor.ready(function(K) {
		$('#CaseForm textarea').each(function(){
...
function checkFrom() {
	...
	var _hastips = false;
	var tipStr = '';
	$('#CaseForm .isrequired').each(function(){
