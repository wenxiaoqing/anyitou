...
$this->menu=array(
	...
	array('label'=>'编辑融资案例', 'url'=>array('caseupdate', 'id' => $notice['id'])),
...
<div class="form-horizontal" >
    <div class="panel panel-primary">
    	...
    	<div class="panel-body" >
			...
			<div class="form-group">
				<label for="item_title" class="col-sm-2 control-label"><?php echo $model->getAttributeLabel('desc'); ?>：<span class="required">*</span></label>
				<div class="col-sm-8 control-info">
				<?php echo $model->desc; ?>
				</div>
				<div class="col-sm-2 control-info">&nbsp;</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-8 control-info">
				<?php echo $model->getRecommendType($model->recommend); ?>
				</div>
				<div class="col-sm-2 control-info">&nbsp;</div>
			</div>
			<div class="form-group">
