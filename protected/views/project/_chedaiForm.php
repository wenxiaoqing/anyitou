...
<div class="tabbable tabbable-custom tabbable-full-width" >
	<ul class="nav nav-tabs">
	    <li class="<?php if(Yii::app()->request->getParam('type') =='invest' ){ echo ' active'; } ?>"><a href="<?php echo $this->createUrl('/project/create'); ?>" >安企贷</a></li>
		...
		<li class="<?php if(Yii::app()->request->getParam('type') == 'fangdai' ){ echo ' active'; } ?>"><a href="<?php echo $this->createUrl('/project/create', array('type' => 'fangdai')); ?>" >安房贷</a></li>
	</ul>
<div class="form-horizontal" >
    ...
    <div class="panel panel-primary">
    	<div class="panel-body" >
			...
			<input type="hidden" name="ItemInfo[category]" value="chedai">												
			<div class="form-group">
