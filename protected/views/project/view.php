...
$this->menu=array(
	...
	array('label'=>'编辑项目', 'url'=>array('update', 'id' => $infoRecord['id'])),
...
<div class="tabbable tabbable-custom tabbable-full-width" >
	...
	<div class="tab-content" >
		...
		<?php echo $this->renderPartial('_viewInfo', array( 'model' => $infoRecord, 
		...
		<?php echo $this->renderPartial('_viewDetail', array( 'model' => $detailRecord)); ?>
		</div>
