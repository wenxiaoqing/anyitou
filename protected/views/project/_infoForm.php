...
<div class="form-horizontal" >
    ...
    <div class="panel panel-primary">
    	...
    	<div class="panel-body" >
			...
			<div class="form-group">
				...
				<?php echo $form->hiddenField($model, 'category', array('class' => 'form-control col-sm-4 isrequired', 'placeholder' => $model->getAttributeLabel('category')) ); ?>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<?php endif;?>
				<input type="hidden" id="borrower_user_id" name="ItemInfo[borrower_user_id]" placeholder="user_id" value="<?php echo $model->borrower_user_id; ?>" >
				</div>
  				<div class="col-sm-5 control-info"></div>
			</div>
			<div class="form-group">
				...
				<?php if(!empty($companyModel)): ?>
					<input type="text" class="form-control col-sm-4 isrequired" id="companyName" placeholder="企业名称" value="<?php echo $companyModel->name; ?>" autocomplete="off" />
				<?php else: ?>
					<input type="text" class="form-control col-sm-4 isrequired" id="companyName" placeholder="企业名称" value="" autocomplete="off" />
				<?php endif;?>
				<input type="hidden" id="company_id" name="ItemInfo[company_id]" placeholder="company_id" value="<?php echo $model->company_id; ?>" >
				</div>
  				<div class="col-sm-5 control-info"></div>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<label for="pay_type" class="col-sm-2 control-label"><?php echo $model->getAttributeLabel('pay_type'); ?>：</label>
				<div class="col-sm-5">
	...
	<div class="panel panel-primary">
    	...
    	<div class="panel-body" >
			<?php echo $form->textArea($model,'capital_opration',array('rows'=>6, 'cols'=>50, 'class' => 'form-control col-sm-4 ', 'placeholder' => $model->getAttributeLabel('capital_opration'))); ?>
		</div>
	</div>
	<div class="panel panel-primary">
		<div class="panel-heading">
    	...
    	<div class="panel-body" >
			<?php echo $form->textArea($model,'risk_control',array('rows'=>6, 'cols'=>50, 'class' => 'form-control col-sm-4 ', 'placeholder' => $model->getAttributeLabel('risk_control'))); ?>
		</div>
	</div>
	<div class="panel panel-primary" style="display:none;" >
    	...
    	<div class="panel-body" >
			<?php echo $form->textArea($model,'collateral_info',array('rows'=>6, 'cols'=>50, 'class' => 'form-control col-sm-4', 'placeholder' => $model->getAttributeLabel('collateral_info'))); ?>
		</div>
	</div>
	<div class="panel panel-primary" style="display:none;" >
		<div class="panel-heading">
    	...
    	<div class="panel-body" >
			<?php echo $form->textArea($model,'desc_detail',array('rows'=>6, 'cols'=>50, 'class' => 'form-control col-sm-4', 'placeholder' => $model->getAttributeLabel('desc_detail'))); ?>
		</div>
	</div>
