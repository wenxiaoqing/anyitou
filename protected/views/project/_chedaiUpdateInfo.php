    	...
    	<div class="panel-body" >
			...
			<div class="form-group">
				...
				<?php if(!empty($user_name)): ?>
					<input type="text" class="form-control col-sm-4 isrequired" id="borrower" placeholder="借款人" value="<?php echo $user_name->user_name; ?>" autocomplete="off" />
				<?php else: ?>
			...
			<div class="form-group">
				...
				<select class="form-control col-sm-4 isrequired" name="ItemInfo[evaluation_company_id]" >
					<?php foreach($evaluation_companys as $record) :?>
