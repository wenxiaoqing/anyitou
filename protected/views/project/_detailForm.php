...
<div class="form-horizontal" >
	...
	<div class="panel panel-primary">
    	...
    	<div class="panel-body" >
			<?php echo $form->textArea($model,'idea_home',array('rows'=>6, 'cols'=>50, 'class' => 'form-control col-sm-4 ', 'placeholder' => $model->getAttributeLabel('idea_home'))); ?>
			<?php echo $form->error($model,'idea_home'); ?>
		</div>
	</div>
	...
	<div class="panel panel-primary">
    	...
    	<div class="panel-body" >
			<?php echo $form->textArea($model,'idea_risk',array('rows'=>6, 'cols'=>50, 'class' => 'form-control col-sm-4 ', 'placeholder' => $model->getAttributeLabel('idea_risk'))); ?>
			<?php echo $form->error($model,'idea_risk'); ?>
		</div>
	</div>
	...
	<div class="panel panel-primary">
    	...
    	<div class="panel-body" >
			<?php echo $form->textArea($model,'idea_credit',array('rows'=>6, 'cols'=>50, 'class' => 'form-control col-sm-4 ', 'placeholder' => $model->getAttributeLabel('idea_credit'))); ?>
			<?php echo $form->error($model,'idea_credit'); ?>
		</div>
	</div>
	...
	<div class="panel panel-primary">
    	...
    	<div class="panel-body" >
			<?php echo $form->textArea($model,'relation_desc',array('rows'=>6, 'cols'=>50, 'class' => 'form-control col-sm-4 ', 'placeholder' => $model->getAttributeLabel('relation_desc'))); ?>
			<?php echo $form->error($model,'relation_desc'); ?>
		</div>
	</div>
